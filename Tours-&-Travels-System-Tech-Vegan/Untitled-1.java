...
//==========================================================================================================
    ...
    private void jbtnReceiptActionPerformed(java.awt.event.ActionEvent evt) 
        ...
        jtxtReceipt.append("\tTravel Management System:\n\n"
            +"Ref:\t\t\t" + ref
            +"\n---------------------------------------" 
        final String Firstname = (jtxtFirstname.getText());
        final String Surname = (jtxtSurname.getText());
        final String address = (jtxtAddress.getText());
        final String postcode =(jtxtPostCode.getText());
        final String telephone = (jtxtTelephone.getText());
        final String Email = (jtxtEmail.getText());
        final String rTax = (jlblTax.getText());
        final String rSubTotal = (jlblSubTotal.getText());
        final final final     +"\nTotal:\t\t\t"+ rTotal  
            +"\n---------------------------------------" 
